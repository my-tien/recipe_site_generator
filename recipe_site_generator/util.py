...
def collect_recipes(input_path: Union[str, Path], recipe_root: str) -> list[RecipeFolder]:
    ...
    for dirpath, _, filenames in Path(input_path).walk():
        ...
        for filename in filenames:
            ...
            if filename == "about.md":
                ...
                recipe_path = str(Path(recipe_root) / dirpath.name / recipe_name)
                ...
                recipe = Recipe(name=recipe_name, path=recipe_path, head=head, instructions=instructions)
